        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1">
              ...
              <input
                {...register("name")}
                placeholder="React..."
                className="w-full border-2 border-black p-2 font-bold outline-none focus:bg-yellow-50 transition-colors"
              />
              {errors.name && (
            ...
            <div className="space-y-1">
              <label className="text-[10px] font-bold text-gray-500 uppercase flex items-center gap-1">
                <Hash size={10} /> Icon Name
              </label>
              <input
                {...register("iconName")}
                placeholder="SiReact..."
                className="w-full border-2 border-black p-2 font-mono text-sm outline-none focus:bg-blue-50 transition-colors"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1">
              ...
              <select
                {...register("category")}
                className="w-full border-2 border-black p-2 bg-white cursor-pointer outline-none uppercase text-xs font-bold focus:bg-gray-50"
              >

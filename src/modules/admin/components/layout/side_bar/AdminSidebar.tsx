...
import { LayoutDashboard, Cpu, Briefcase, Mail, Home } from 'lucide-react';
import SidebarItem from './SidebarItem';
import LogoutButton from './LogoutButton';
import { Suspense } from 'react'; // Cần cái này để tránh lỗi build khi dùng useSearchParams

const MENU_ITEMS = [
  { label: 'Overview', icon: Home, href: '/admin?tab=overview', slug: 'overview' }, 
...
function AdminSidebarContent() {
  ...
  return (
    <aside className="fixed left-0 top-0 z-40 h-screen w-64 flex flex-col bg-black text-white p-6 shadow-xl md:flex border-r-4 border-yellow-400">
      <div className="mb-10 px-2">
        <h1 className="text-2xl font-black tracking-tighter text-yellow-400 uppercase">
          KYONE.<span className="text-white">OS</span>
        </h1>
      ...
      <div className="mb-4 px-2 py-2 bg-zinc-900 rounded border border-zinc-800 text-[15px] font-mono text-zinc-400">
